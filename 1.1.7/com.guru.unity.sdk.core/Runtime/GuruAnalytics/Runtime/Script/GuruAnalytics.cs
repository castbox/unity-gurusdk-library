...
namespace Guru
{
    ...
    public class GuruAnalytics
    {
        ...
        public void SetScreen(string screenName)
        {
            if (!_isReady) 
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetScreen: {screenName}");
                return;
            }
        ...
        public void SetAdId(string id)
        {
            if (!_isReady) 
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetAdId: {id}");
                return;
            }
        ...
        public void SetFirebaseId(string id)
        {
            if (!_isReady) 
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetFirebaseId: {id}");
                return;
            };
            if (string.IsNullOrEmpty(id)) return;
        ...
        */
        ...
        public void SetAdjustId(string id)
        {
            if (!_isReady)
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetAdjustId: {id}");
                return;
            }
            if (string.IsNullOrEmpty(id)) return;
        ...
        public void SetDeviceId(string deviceId)
        {
            if (!_isReady)
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetDeviceId: {deviceId}");
                return;
            }
        ...
        public void SetAndroidId(string androidId)
        {
            if (!_isReady) 
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetAndroidId: {androidId}");
                return;
            }
        ...
        public void SetIDFV(string idfv)
        {
            if (!_isReady) 
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetIDFV: {idfv}");
                return;
            }
        ...
        public void SetIDFA(string idfa)
        {
            if (!_isReady)
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetIDFA: {idfa}");
                return;
            }
        ...
        public void SetUid(string uid)
        {
            if (!_isReady)
            {
                Debug.LogWarning($"{Tag}[GA] --- is Not Ready SetUid: {uid}");
                return;
            }
