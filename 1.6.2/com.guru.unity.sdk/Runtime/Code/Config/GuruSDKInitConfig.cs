...
namespace Guru
{
    ...
    public class GuruSDKInitConfig
    {
        ...
        /// <summary>
        /// 是否SDK内部设置SetHasUserConsent
        /// </summary>
        public bool AutoSetHasUserConsent = true;
    ...
    public class GuruSDKInitConfigBuilder
    {
        ...
        /// <summary>
        /// 巴西隐私政策相关策略是否中台内部设置，如果项目自己处理需要设置为false
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public GuruSDKInitConfigBuilder SetAutoHasUserConsent(bool value)
        {
            _config.AutoSetHasUserConsent = value;
            return this;
        }
